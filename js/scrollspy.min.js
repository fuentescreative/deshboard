...
+(function (b) {
	function c(a, h) {
		...
		this.scrollHeight = 0;
		this.$scrollElement.on('scroll.wb.scrollspy', b.proxy(this.process, this));
		this.refresh();
		this.process();
	}
	function l(a) {
		return this.each(function () {
			var h = b(this),
				g = h.data('wb.scrollspy'),
				f = 'object' == typeof a && a;
			g || h.data('wb.scrollspy', (g = new c(this, f)));
	...
	c.prototype.process = function () {
		...
		if (a >= c) return k != (e = d[d.length - 1]) && this.activate(e);
		if (k && a < f[0]) return (this.activeTarget = null), this.clear();
		for (e = f.length; e--; )
			k != d[e] &&
				a >= f[e] &&
				(void 0 === f[e + 1] || a < f[e + 1]) &&
				this.activate(d[e]);
	};
	c.prototype.activate = function (a) {
		...
		b(
			...
			.addClass('active')
			.trigger('activate.wb.scrollspy');
	};
	c.prototype.clear = function () {
		b(this.selector).removeClass('active');
	};
	var m = b.fn.scrollspy;
	b.fn.scrollspy = l;
	...
	b(window).on('load.wb.scrollspy.data-api', function () {
